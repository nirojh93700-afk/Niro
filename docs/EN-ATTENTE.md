...
> **Mis à jour le 22/09/2026.** Ce fichier est l'index unique pour reprendre le travail depuis
...
| **Aurore Corcy** (`aurorecorcy@gmail.com`) — carafe + 2 verres de mariage | Notre réponse du 30/08, **silence depuis** (vérifié 22/09 : rien d'elle dans Gmail ni sur le site). Relance du 07/09 **toujours pas envoyée**, texte valable (aucune promesse) — le gérant n'a pas dit « envoie » pour elle le 22/09 | `docs/messages/aurore-relance.md` |
