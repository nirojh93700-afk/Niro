...
<p>Le retrait en main propre est proposé uniquement pour la décoration et le mariage, dans le secteur de l'atelier (Val-d'Oise et alentours), gratuitement et <strong>sur rendez-vous</strong>. Dès que votre commande est prête, nous vous prévenons par e-mail ou téléphone pour convenir d'un créneau ; vous présentez votre <strong>numéro de commande</strong> au retrait.</p>
<p><strong>Délai de retrait : 14 jours</strong> à compter de notre message vous indiquant que la commande est prête. Passé ce délai, sans retrait de votre part, la commande — étant personnalisée et fabriquée sur mesure — est considérée comme abandonnée : elle <strong>ne pourra être ni remboursée, ni expédiée</strong>. Si vous habitez en dehors du secteur, contactez-nous <strong>avant de commander</strong>.</p>
