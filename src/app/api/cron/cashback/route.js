import { runCashbackJobs } from "@/lib/jobs";

export const dynamic = "force-dynamic";
export const runtime = "nodejs";

// Rappels/expiration de cagnotte — à appeler 1×/jour par un planificateur :
//   /api/cron/cashback?token=SECRET
