      ...
      <div onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 18, maxWidth: 420, width: "100%", padding: "32px 26px", textAlign: "center", position: "relative", boxShadow: "0 12px 44px rgba(0,0,0,0.22)" }}>
        ...
        {done ? (
          <>
            ...
            <p style={{ fontSize: "0.82rem", color: "var(--ink-soft)", margin: "0 0 16px" }}>📩 Votre code vous a aussi été envoyé par e-mail. Vous ne le trouvez pas ? <strong>Pensez à regarder vos spams</strong> (courriers indésirables).</p>
