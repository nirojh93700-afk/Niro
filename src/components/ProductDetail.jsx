        ...
        <div className="product-info">
          ...
          {product.pickup && (
            <div style={{ marginTop: 12, background: "#fbf4e6", border: "1px solid #e7d3a1", borderRadius: 12, padding: "12px 14px", fontSize: "0.88rem" }}>
              ...
              <br />C'est vous qui venez récupérer votre commande à l'atelier, sous <strong>14 jours</strong> après notre message « commande prête ». Au-delà, la commande personnalisée ne pourra plus être ni remboursée, ni expédiée.
