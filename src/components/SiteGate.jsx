...
// Page d'accès : s'affiche tant que le visiteur n'a pas entré le bon code.
    ...
    >
      ...
      >
        ...
        <p style={{ color: "var(--ink-soft)", marginTop: 0, marginBottom: 22, fontSize: "0.95rem" }}>
          Notre boutique ouvre bientôt. Entrez votre code d'accès pour découvrir
          le site en avant-première.
        </p>
