...
export const products = [
  // ----------------------------- BIJOUX --------------------------------------
  {
    ...
    personalizationFields: [
      ...
      { key: "motifPos1", type: "select", label: "Recto — motif placé", optional: true, options: [{ value: "above", label: "Au-dessus du texte" }, { value: "below", label: "En dessous du texte" }] },
      ...
      { key: "motifPos2", type: "select", label: "Verso — motif placé", optional: true, variantContains: "Recto-Verso", options: [{ value: "above", label: "Au-dessus du texte" }, { value: "below", label: "En dessous du texte" }] },
...
<p><em>Conseil : une photo nette et contrastée donne le plus beau rendu. Un socle lumineux LED est disponible séparément.</em></p>`,
  },
  {
    ...
    variants: [
      { id: "cuir-tresse-argente", title: "Argenté", price: 22.90 },
      { id: "cuir-tresse-dore", title: "Doré", price: 22.90 },
      { id: "cuir-tresse-noir", title: "Noir", price: 22.90 },
    ],
...
<ul><li>Acier inoxydable hypoallergénique</li><li>Argenté ou doré</li></ul>`,
  ...
  },
  {
    ...
    variants: [
      { id: "papillon-argente", title: "Argenté", price: 27.90 },
      { id: "papillon-dore", title: "Doré", price: 27.90 },
      { id: "papillon-noir", title: "Noir", price: 24.90 },
      { id: "papillon-or-rose", title: "Or Rose", price: 29.90 },
    ],
  ...
  },
  {
    ...
    variants: [
      { id: "rond-retro-argente", title: "Argenté", price: 22.90 },
      { id: "rond-retro-noir", title: "Noir", price: 22.90 },
    ],
  ...
  },
  {
    ...
    variants: [
      { id: "plaque-acier-noir", title: "Acier Noir", price: 32.90 },
      { id: "plaque-argente", title: "Argenté", price: 29.90 },
      { id: "plaque-argente-noir", title: "Argenté et Noir", price: 33.90 },
...
<p>Personnalisez le <strong>recto</strong> (inclus), ajoutez une gravure au <strong>verso</strong> (+5 €) et même une <strong>photo gravée</strong> (+8 €).</p>`,
  },
  {
    ...
    personalizationFields: [
      ...
      { key: "motifPos1", type: "select", label: "Couverture — motif placé", optional: true, options: [{ value: "above", label: "Au-dessus du texte" }, { value: "below", label: "En dessous du texte" }] },
      ...
      { key: "motifPos2", type: "select", label: "Page 1 — motif placé", optional: true, options: [{ value: "above", label: "Au-dessus du texte" }, { value: "below", label: "En dessous du texte" }] },
      ...
      { key: "motifPos3", type: "select", label: "Page 2 — motif placé", optional: true, options: [{ value: "above", label: "Au-dessus du texte" }, { value: "below", label: "En dessous du texte" }] },
      ...
      { key: "motifPos4", type: "select", label: "Page 3 — motif placé", optional: true, options: [{ value: "above", label: "Au-dessus du texte" }, { value: "below", label: "En dessous du texte" }] },
      { key: "police", type: "font", label: "Police de gravure", optional: true },
    ],
    images: [
    ...
    variants: [
      { id: "medaillon-livre-argente", title: "Argenté", price: 40.90 },
  ...
  },
  {
    ...
    variants: [
      { id: "puzzle-argente", title: "Argenté", price: 19.90 },
      { id: "puzzle-or-rose", title: "Or Rose", price: 22.90 },
    ],
  ...
  },
  {
    ...
    variants: [
      { id: "geo-argente", title: "Argenté", price: 26.90 },
      { id: "geo-arc-en-ciel", title: "Arc en Ciel", price: 30.90 },
      { id: "geo-dore", title: "Doré", price: 29.90 },
      { id: "geo-noir", title: "Noir", price: 29.90 },
      { id: "geo-or-rose", title: "Or Rose", price: 29.90 },
    ],
