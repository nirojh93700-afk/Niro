      ...
      { key: "couverts", type: "couverts", label: "Choisissez un animal pour chaque couvert",
        ...
        pieces: [
          { key: "couteau", label: "Couteau",
            zone: { cx: 0.213, nameCy: 0.62, animalCy: 0.80, animalH: 0.055 },
            zoomZone: { cx: 0.145, nameCy: 0.42, animalCy: 0.80, animalH: 0.22 } },
          { key: "fourchette", label: "Fourchette",
            zone: { cx: 0.396, nameCy: 0.62, animalCy: 0.80, animalH: 0.055 },
            zoomZone: { cx: 0.365, nameCy: 0.42, animalCy: 0.80, animalH: 0.22 } },
          { key: "grande", label: "Grande cuillère",
            zone: { cx: 0.619, nameCy: 0.62, animalCy: 0.80, animalH: 0.055 },
            zoomZone: { cx: 0.63, nameCy: 0.42, animalCy: 0.80, animalH: 0.22 } },
          { key: "petite", label: "Petite cuillère",
            zone: { cx: 0.821, nameCy: 0.66, animalCy: 0.82, animalH: 0.05 },
            zoomZone: { cx: 0.871, nameCy: 0.42, animalCy: 0.80, animalH: 0.22 } },
        ],
        themes: [
