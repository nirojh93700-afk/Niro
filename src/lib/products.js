...
export const products = [
  // ----------------------------- BIJOUX --------------------------------------
  {
    ...
    weight: 50, // grammage emballé (g) — sert au calcul des frais de port
...
<p>Une famille, un groupe d'amis, un couple, un mariage, un hommage. Cristal optique K9, gravure photo 3D interne au laser, gravé en France.</p>`,
  ...
  // ===== Bracelets =====
  {
    ...
    weight: 70, pickup: false, letter: true, subcategory: "homme",
...
<ul><li>Acier inoxydable hypoallergénique</li><li>Fermoir sécurisé</li><li>Gravure prénom, date ou message</li></ul>`,
  },
  {
    ...
    weight: 50, pickup: false, letter: true, subcategory: "femme",
...
<ul><li>Acier inoxydable, ne ternit pas</li><li>Gravure fine au laser</li></ul>`,
  },
  {
    ...
    weight: 50, pickup: false, letter: true, subcategory: "bebe",
...
<li><strong>Gravure :</strong> laser, sur la médaille cœur — recto et/ou verso, 3 € par face gravée</li>
  ...
  // ===== Colliers =====
  {
    ...
    weight: 60, pickup: false, letter: true, subcategory: "couple",
...
<p>C'est le cadeau facile : la taille s'ajuste toute seule, plus besoin de connaître le tour de poignet de la personne à qui vous l'offrez.</p>`,
  ...
  },
  {
    ...
    weight: 50, pickup: false, letter: true, subcategory: "couple",
