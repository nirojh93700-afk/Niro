...
<p><em>Sublimé par un socle lumineux LED (disponible séparément).</em></p>`,
  },
  {
    ...
    personalizationFields: [
      ...
      { key: "note-socle", type: "note", image: "/produits/socle-led-rectangle.jpg", imageByVariant: { "cristal-v-petit": "/produits/socle-led-carre.jpg" }, imageAlt: "Socle lumineux LED rotatif", text: "Socle lumineux LED rotatif (en option) : pose et illumine votre cristal, avec des couleurs qui changent au toucher. Livré avec câble et prise. L'effet 3D est sublimé, surtout le soir. La forme du socle s'adapte à la taille choisie." },
...
<p>Un couple, une naissance, une famille, un mariage, un hommage. Cristal optique K9, gravure photo 3D interne au laser, gravé en France.</p>`,
  },
  {
    ...
    personalizationFields: [
      ...
      { key: "texte", label: "Texte à graver (optionnel)", placeholder: "Prénom, date, petit mot…", maxLength: 40, optional: true },
      { key: "police", type: "font", label: "Police (si texte)", optional: true },
      { key: "note-socle", type: "note", image: "/produits/socle-led-rectangle.jpg", imageByVariant: { "cristal-h-petit": "/produits/socle-led-carre.jpg" }, imageAlt: "Socle lumineux LED rotatif", text: "Socle lumineux LED rotatif (en option) : pose et illumine votre cristal, avec des couleurs qui changent au toucher. Livré avec câble et prise. L'effet 3D est sublimé, surtout le soir. La forme du socle s'adapte à la taille choisie." },
      { key: "socle", type: "select", label: "Ajouter un socle lumineux LED", optional: true, options: [{ value: "", label: "Sans socle" }, { value: "oui", label: "Avec socle LED — +19,90 €" }] },
    ],
    engravingPricing: { flatExtras: [{ key: "socle", value: "oui", amount: 19.9 }] },
