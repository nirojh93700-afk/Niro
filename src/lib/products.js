...
export const products = [
  // ----------------------------- BIJOUX --------------------------------------
  {
    ...
    personalizationFields: [
      ...
      { key: "motif1", type: "motif", label: "Motif — recto", optional: true, options: MOTIF_OPTIONS },
      ...
      { key: "motif2", type: "motif", label: "Motif — verso", optional: true, variantContains: "Recto-Verso", options: MOTIF_OPTIONS },
