...
const COLLIERS = ["collier-enveloppe-message-secret", "collier-medaillon-coeur-ouvrable", "collier-couple-coeur-lot2", "collier-plaque-acier", "collier-medaillon-livre", "collier-couple-puzzle", "collier-femme-pendentif-geometrique", "collier-coeur-zircon", "collier-perle-solitaire", "collier-coeur-scintillant"];
...
const BRACELETS_CARRE = ["bracelet-femme-acier", "bracelet-femme-coeur", "bracelet-femme-papillon", "bracelet-coeur-acier", "bracelet-coeur-a-graver-ot", "bracelet-ange", "bracelet-maille-trombone"];
