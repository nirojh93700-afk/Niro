...
# VIDEO 9 (22/09/2026) : familles JAMAIS filmees depuis la video 1 -- bijoux
# geometriques, deco bois de mariage, porte-stylos et lampe gravee.
# Aucune photo en commun avec les videos 1 a 8. Toutes verifiees gravees.
# Ecartes apres verification (VIERGES) : collier_plaque_a_graver_*, pendentif
# geometrique, puzzle, bracelet_homme_chaine/rond_retro, bracelet_cuir_tresse,
# piece_laiton, cle_usb_en_bois. Ecartes aussi : les photos portant des COTES
# techniques en anglais (Material / Length), et arbre-vie (motif decoupe, pas
# une personnalisation) + support-telephone (deja dans la video des nouveautes).
P = [
    ("collier_enveloppe_a_graver_dore.jpg", "Collier Enveloppe", "Un mot grav\u00e9 sur la carte"),
    ("collier_medaillon_en_forme_de_c_ur_a_graver_argente.jpg", "Collier M\u00e9daillon C\u0153ur", "Un motif grav\u00e9, une photo dedans"),
    ("bracelet_papillon_ajoure_a_graver_dore.jpg", "Bracelet Papillon", "Un papillon et votre texte"),
    ("numero_table_arche_geometrique_relief_bois.jpeg", "Num\u00e9ro de table", "Le num\u00e9ro, l\u2019ann\u00e9e, le d\u00e9cor"),
    ("numero_table_rectangulaire_feuillage_bois.png", "Num\u00e9ro de table", "D\u00e9coup\u00e9 et grav\u00e9 dans le bois"),
    ("porte-stylo-coq-1.jpg", "Porte-stylo grav\u00e9", "Aux couleurs de son \u00e9quipe"),
    ("porte-stylo-espagne-1.jpg", "Porte-stylo grav\u00e9", "Chaque pays a le sien"),
    ("psg-lampe-couleur.jpg", "Lampe grav\u00e9e", "Le logo de son club, r\u00e9tro\u00e9clair\u00e9"),
]
SEG_DUR = 2.2
...
segs = []
segs.append(("card", card("NiV CRÉATION", "Bois, acier et lumière").convert("RGB"), None, INTRO_DUR))
...
wri = imageio.get_writer(f"{OUT}/produits_graves_3.mp4", fps=FPS, codec="libx264", quality=8,
...
subprocess.run([FF, "-y", "-i", f"{OUT}/produits_graves_3.mp4",
    "-vf", "scale=720:1280", "-c:v", "libx264", "-profile:v", "main", "-pix_fmt", "yuv420p",
    "-crf", "26", "-preset", "medium", "-an", "-movflags", "+faststart",
    f"{OUT}/niv-produits-graves-3.mp4"],
    stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, check=True)
print("DUREE %.1fs" % total, "| taille", os.path.getsize(f"{OUT}/niv-produits-graves-3.mp4"))
