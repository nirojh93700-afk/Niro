...
dc=tts(CTA_VO,f"{OUT}/bvo_cta.wav");segs.append(("card",card("nivcreation.fr","Commandez & personnalisez","Fait main · en France").convert("RGB"),None,max(MIN,PRE+dc+0.5),f"{OUT}/bvo_cta.wav"))
