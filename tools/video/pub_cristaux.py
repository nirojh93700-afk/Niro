...
di=tts(INTRO_VO,f"{OUT}/cvo_intro.wav");segs.append(("card",card("NiV CRÉATION","Cristal Photo 3D · gravé en France").convert("RGB"),None,max(MIN,PRE+di+0.3),f"{OUT}/cvo_intro.wav"))
