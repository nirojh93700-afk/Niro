...
const PAGES = [
  ...
  ["/idees", "Idées & conseils (sommaire)"],
  ["/idees/cadeau-femme-personnalise", "Guide cadeau femme"],
  ["/idees/idees-gravure-bijoux", "Guide que faire graver"],
  ["/idees/bijoux-homme-graves", "Guide bijoux homme"],
  ["/idees/cadeau-couple", "Guide cadeau de couple"],
  ["/idees/cadeau-naissance", "Guide cadeau de naissance"],
  ["/idees/deco-mariage-personnalisee", "Guide déco de mariage"],
  ["/idees/cristal-photo-3d", "Guide cristal photo 3D"],
  ["/idees/verres-carafes-graves", "Guide verres & carafes"],
  ["/idees/deco-lumineuse-bois", "Guide déco lumineuse"],
  ["/idees/cle-usb-personnalisee-gravee", "Guide clé USB gravée"],
  ["/idees/porte-cles-piece-a-graver", "Guide porte-clés & pièce"],
  ["/idees/cadeau-enfant-personnalise", "Guide cadeau enfant"],
  ["/idees/porte-stylo-bois-personnalise", "Guide porte-stylo"],
