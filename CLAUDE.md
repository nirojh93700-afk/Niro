...
>     1. **Quota ramené de 4 à 1 élément inclus** — la note dit maintenant « Le premier élément est inclus dans le prix — chaque élément en plus : +2,90 € » (le compteur passe direct à « X en plus » dès le 2ᵉ élément, quel que soit son type : dessin, cadre, lettre ou texte).
