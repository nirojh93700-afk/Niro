...
> - **Verre à whisky (fiches whisky portrait + fête des pères)** : **Arcoroc Islande 30 cl** (fournisseur **Metro**, réf `AAA0001186981`, ~1-2 €/verre). Correspond exactement à la fiche : 300 ml, H ~9,4 cm, Ø ~7,8 cm, base épaisse, paroi lisse (idéale gravure photo). Enregistré le 24/08/2026. **Alternative équivalente** : METRO Professional Tumbler **Lario 30 cl** (réf `AAA0000163284`, lot de 12, Ø 7,9 × H 9,3 cm, fond lourd, paroi lisse, NON trempé — idéal laser, fabriqué en France).
